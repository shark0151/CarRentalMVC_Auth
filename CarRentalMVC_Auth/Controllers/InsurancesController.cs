...
namespace CarRentalMVC_Auth.Controllers
{
    public class InsurancesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,type,rate,description")] Insurance insurance)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,type,rate,description")] Insurance insurance)
        {
            if (id != insurance.Id)
            {
                return NotFound();
