...
namespace CarRentalMVC_Auth.Controllers
{
    [Route("[controller]")]
    [ApiController]
    public class Vehicle_GraphController : ControllerBase
    {
        ...
        public IEnumerable<string> Get()
        {
            ...
            vertices = GraphDbService.GetAll(".hasLabel('Vehicle')");
            return vertices;
        }
        ...
        {
            List<string> vertices = new List<string>();
            vertices = GraphDbService.GetAll($".hasLabel('Vehicle').has('id', '{id}')");
            try
            {
                return vertices[0];
            }
        ...
        [HttpPost]
        [ActionName("Create")]
        public void Post([FromBody] Vehicle_Graph value)
        {
            string output;
        ...
        [HttpPut]
        [ActionName("Edit")]
        public void Put([FromBody] Vehicle_Graph value)
        {
            string output;
        ...
        public void Delete(string id)
        {
            ...
            output = GraphDbService.Delete(id, ".hasLabel('Vehicle')");
        }
